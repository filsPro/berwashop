...
$sql="SELECT * FROM productin where productcode='$productcode'";
...
$sql="UPDATE productin SET productcode='$productcode',date='$date',quantity='$quantity',uniqueprice='$uniqueprice',totalprice='$totalprice' where productcode='$productcode'";
$result= mysqli_query($link,$sql);
