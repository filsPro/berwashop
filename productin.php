...
<form method="post" action="addproductin.php">
...
<tr>
	...
	<td><a href="removeproduct.php?productcode=<?php echo $row['productcode']; ?>" onclick="return confirm('Are you sure you want to delete?')" class="delete">delete</a>||
	    <a href="updateproductin.php?productcode=<?php echo $row['productcode']; ?>" class="update">update</a></td>
</tr>
<?php }?>
</table>
</div>
